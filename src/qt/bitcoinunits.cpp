...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("CharlieChaplinCoins"));
    case mBTC: return QString(QObject::tr("Milli-CharlieChaplinCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-CharlieChaplinCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
