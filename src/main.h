...
static const uint256 hashGenesisBlock("0x00000a3ff682f55ca64908923c5c9b18bed8e60cce1baceb6f9da5324137861c");
static const uint256 hashGenesisBlockTestNet("0x000c763e402f2436da9ed36c7286f62c3f6e5dbafce9ff289bd43d7459327eb");

inline int64_t PastDrift(int64_t nTime)   { return nTime - ((6.67 * 3 + 10) * 60); } // up to this from the past
...
public:
    ...
    {
        // Protocol switch to support p2pool at CharlieChaplinCoin block #0
        ...
        // Before CharlieChaplinCoin block #0 - get from pregenerated table
