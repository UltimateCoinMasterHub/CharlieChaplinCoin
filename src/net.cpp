...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("CharlieChaplinCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("CharlieChaplinCoin-net");
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("CharlieChaplinCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("CharlieChaplinCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("CharlieChaplinCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("CharlieChaplinCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CharlieChaplinCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("CharlieChaplinCoin-start");
