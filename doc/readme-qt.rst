CharlieChaplinCoin-qt: Qt4 GUI for CharlieChaplinCoin
===============================
...
Alternatively, install Qt Creator and open the `CharlieChaplinCoin-qt.pro` file.

An executable named `CharlieChaplinCoin-qt` will be built.
...
A warning for people using the *static binary* version of CharlieChaplinCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of CharlieChaplinCoin is linked against libdb5.3.
...
installed causes CharlieChaplinCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
